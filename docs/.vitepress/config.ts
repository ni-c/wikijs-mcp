...
const site = 'https://wikijs-mcp.ni-c.de';
const description =
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:site_name', content: 'wikijs-mcp' }],
    ['meta', { property: 'og:title', content: 'wikijs-mcp' }],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Reference', link: '/reference/tools', activeMatch: '/reference/' },
      {
        ...
        items: [
          ...
          { text: 'Releases', link: 'https://github.com/ni-c/wikijs-mcp/releases' },
          { text: 'npm package', link: 'https://www.npmjs.com/package/@ni-c/wikijs-mcp' },
        ],
      },
    ],
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is wikijs-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/wikijs-mcp' },
      {
        icon: {
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/wikijs-mcp/edit/main/docs/:path',
